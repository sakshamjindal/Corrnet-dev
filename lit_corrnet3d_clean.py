...
class LitCorrNet3D(pl.LightningModule):
    ...
    def step(self, batch, batch_idx):
        ...
        rec_term, rank_term, mfd_term, supervised_loss = self._run_loss(pinput1.transpose(2, 1), input2.transpose(2, 1), p, out_a, out_b, label)
        #breakpoint()
        self.sl_coeff = 1.0
        ...
        logs = {
            ...
            "supervised_loss(x{})".format(str(self.sl_coeff)): supervised_loss
        }
